function [estVB_EOT_SN] = gen_estVB_EOT_SN_targets(ett_measurements,ett_ground_truth)
K=150;
nz=2;
nx=4;
...
for t=1:K 
    ...
    B = sqrt_M * inv_sqrt_E_extentkk;
        ...
        VK=sitakk2*(1-taok*kasaikk/sqrt(sitakk2)-taok^2);
        E_pk=kasaikk+sqrt(sitakk2)*taok;
        IWvkk=IWvk1k+nk;
        Dk=(zk_bar-H*xkk-dk*E_pk)*(zk_bar-H*xkk-dk*E_pk)'+H*Pkk*H'+dk*VK*dk';
     ...
     eststates(:, t)= xkk;
     estVB_EOT_SN.states = eststates;
     estVB_EOT_SN.extents = estextents;
end
